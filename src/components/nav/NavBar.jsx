...
export const NavBar = ({ token, setToken }) => {
  ...
  return (
    <nav className="navbar navbar-expand-lg p-0 bg-green-800/80 text-white">
        ...
        {token ? (
          <div>
            <ul className="navbar-nav me-auto mb-2 mb-lg-0 items-center ">
              <li className="nav-item mx-4 px-4 py-0.5 hover:bg-green-800/90">
                <Link
                  to="recipes/all"
              ...
              <li className="nav-item px-4 py-0.5 hover:bg-green-800/90">
